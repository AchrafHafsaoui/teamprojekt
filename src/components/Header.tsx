...
const Header: React.FC = () => {
  ...
  return (
    <div 
      ...
      style={{ paddingLeft: '250px' }}  // Adjusts header to avoid sidebar overlap
    >
      <div className="flex space-x-6 mr-10 text-base items-center">
        {headerItems.map((item) => (
          ...
          >
            <span
              className="tracking-wide whitespace-nowrap text-gray-800 hover:ml-1 transition-transform duration-300"
              style={{
