      ...
      <div className="flex flex-col space-y-2 mt-4">
        ...
        {menuItems.map((item) => (
          ...
          >
            ...
            <span
              className={`whitespace-nowrap overflow-hidden ${activeButton === item.label ? "font-semibold text-[rgb(7, 142, 205)]" : "text-gray-800"} text-lg tracking-wide transition-all`}
              style={{
